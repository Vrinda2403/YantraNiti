    ...
    return (
        ...
        >
            ...
            <div className="border-t border-primary-mid">
                <div className="max-w-7xl mx-auto px-4 sm:px-8 py-6 flex flex-col sm:flex-row items-center justify-between text-sm">
                    {/* Left Side: Copyright */}
                    <p className="text-text-light/50 text-center sm:text-left mb-4 sm:mb-0">
                        &copy; {new Date().getFullYear()} Yantraniti | All Rights Reserved.
                    </p>
                    {/* Right Side: Hackathon Info */}
                    <div className="text-center sm:text-right">
                        <p className="font-bold text-accent-gold">SMART INDIA HACKATHON 2025</p>
                        <p className="text-text-light/50">Team: Mind Canvas</p>
                    </div>
                </div>
            </div>
        </footer>
